(function () {
  ...
  function setMicActive(active) {
    ...
    button.setAttribute("aria-label", active ? "Stop Jarvis wake mode" : "Start Jarvis wake mode");
  }
  ...
  function showUnsupported() {
    ...
    setCoreStatus("SpeechRecognition is unavailable here", "Jarvis offline");
  ...
  function init() {
    ...
    setWakeStatus("Off");
    setCoreStatus("Tap mic to arm wake mode", "Wake phrase: Hey Jarvis");
    addMessage("system", "Jarvis online. Tap the mic, say Hey Jarvis, then speak a command.");
  }
